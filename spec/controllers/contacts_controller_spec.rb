  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contact as @contact" do
        ...
        post :create, {:contact => { "country" => "invalid value" }}, valid_session
        assigns(:contact).should be_a_new(Contact)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contact" do
        ...
        Contact.any_instance.should_receive(:update).with({ "country" => "" })
        put :update, {:id => contact.to_param, :contact => { "country" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contact as @contact" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contact.any_instance.stub(:save).and_return(false)
        put :update, {:id => contact.to_param, :contact => { "country" => "invalid value" }}, valid_session
        assigns(:contact).should eq(contact)
      end
