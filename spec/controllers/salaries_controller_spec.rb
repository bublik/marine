  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved salary as @salary" do
        ...
        post :create, {:salary => { "amount" => "invalid value" }}, valid_session
        assigns(:salary).should be_a_new(Salary)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested salary" do
        ...
        Salary.any_instance.should_receive(:update).with({ "amount" => "1" })
        put :update, {:id => salary.to_param, :salary => { "amount" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the salary as @salary" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Salary.any_instance.stub(:save).and_return(false)
        put :update, {:id => salary.to_param, :salary => { "amount" => "invalid value" }}, valid_session
        assigns(:salary).should eq(salary)
      end
