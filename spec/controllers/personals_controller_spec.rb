...
describe PersonalsController do
  ...
  let(:valid_attributes) { { "available_from" => "2014-04-08 21:47:44" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved personal as @personal" do
        ...
        post :create, {:personal => { "available_from" => "invalid value" }}, valid_session
        assigns(:personal).should be_a_new(Personal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested personal" do
        ...
        Personal.any_instance.should_receive(:update).with({ "available_from" => "2014-04-08 21:47:44" })
        put :update, {:id => personal.to_param, :personal => { "available_from" => "2014-04-08 21:47:44" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the personal as @personal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Personal.any_instance.stub(:save).and_return(false)
        put :update, {:id => personal.to_param, :personal => { "available_from" => "invalid value" }}, valid_session
        assigns(:personal).should eq(personal)
      end
